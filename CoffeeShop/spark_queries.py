...
class spark_queries:
    ...
    def df_demo(self, spark):
        print("\nReturning list of all our active branches:\n")
        spark.sql("SELECT DISTINCT b.branch FROM bev_branches b join bev_conscount c on b.beverage=c.beverage ORDER BY b.branch asc").show()
